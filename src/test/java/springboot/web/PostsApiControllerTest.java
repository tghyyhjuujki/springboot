...
public class PostsApiControllerTest {
	...
	public void Posts_등록된다() throws Exception { 
		...
		/*
		 * // when ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url,
		 ...
		 * postsRepository.findById(responseEntity.getBody()); if (optional.isPresent())
	...
	public void Posts_수정된다() throws Exception { 
		...
		/*
		 * // when ResponseEntity<Long> responseEntity = restTemplate.exchange(url,
